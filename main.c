/***************************************************************************
 *   PhoenixSSL - A TLS hacking tool                                  	   *
 *   Copyright 2016 by Ramesh Kumar                    					   *
 *                                                                         *
 *                                                                         *
...
const char *program_banner = "                   _\n"
                             ...
                             "                  Version 0.0.1\n"
                             "      									\n"
                             "        Copyright Ramesh Kumar 2016\n";
const char *program_version = "sslscan version 0.0.1 (C) Ramesh Kumar 2016\n";
const char *xml_version = "0.0.1";
